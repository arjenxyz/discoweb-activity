...
export const localDevMailsSeed = [
  ...
  },
  {
    ...
    body: 'Toplam: 42.5 Papel\nMesaj: 28 Papel\nSes: 14.5 Papel',
    category: 'system',
    status: 'published' as const,
    created_at: new Date(Date.now() - 155_000_000).toISOString(),
    author_name: 'DiscoWeb',
    author_avatar_url: LOCAL_DEV_AVATAR,
    is_read: false,
    is_starred: false,
  ...
  {
    id: 'mail-earn-reject-1',
    title: 'Kazançlarınız hesabınıza tanımlanmadı',
    body: 'Durum: tanımlanmadı\nSebep: wallet_failed\nTutar: 18 Papel',
    category: 'system',
    status: 'published' as const,
    created_at: new Date(Date.now() - 150_000_000).toISOString(),
    author_name: 'DiscoWeb',
    author_avatar_url: LOCAL_DEV_AVATAR,
    is_read: false,
    is_starred: false,
  ...
  {
    id: 'mail-quiz-reward-1',
    title: 'Cuma Akşamı Quiz — 125 Papel Kazandınız',
    body: 'Etkinlik: Cuma Akşamı Quiz\nToplam: 125 Papel\nDoğru: 10/10\nYanlış: 0',
    category: 'system',
    status: 'published' as const,
    created_at: new Date(Date.now() - 145_000_000).toISOString(),
    author_name: 'DiscoWeb',
    author_avatar_url: LOCAL_DEV_AVATAR,
    is_read: false,
    is_starred: false,
    metadata: {
      ...
      i18nKey: 'quiz_reward',
      source: 'quiz_reward',
      event_id: 'quiz-evt-1042',
      quiz_title: 'Cuma Akşamı Quiz',
      total_earned: 125,
      checkpoint_papel: 75,
      perfect_bonus: 50,
  ...
  {
    id: 'mail-quiz-motivation-1',
    title: 'Cuma Akşamı Quiz — Katıldığın İçin Teşekkürler',
    body: 'Etkinlik: Cuma Akşamı Quiz\nDoğru: 2/10\nYanlış: 1\nUlaşılan soru: 3/10\nDurum: elendi',
    category: 'system',
    status: 'published' as const,
    created_at: new Date(Date.now() - 140_000_000).toISOString(),
    author_name: 'DiscoWeb',
    author_avatar_url: LOCAL_DEV_AVATAR,
    is_read: false,
    is_starred: false,
