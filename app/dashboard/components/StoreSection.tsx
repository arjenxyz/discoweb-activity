...
export default function StoreSection({
  ...
  return (
    <>
      <section className="relative overflow-hidden rounded-none border-0 bg-white/5 backdrop-blur-2xl p-3 sm:p-8 shadow-2xl transition-all sm:min-h-0 flex flex-col flex-1 min-h-full">
