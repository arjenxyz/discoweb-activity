...
export default function DashboardHeader({
  ...
  return (
    <>
      ...
      <header className={`relative mx-3 mt-5 mb-1 flex items-center rounded-2xl border border-white/[0.1] bg-[#12141c]/92 shadow-[0_10px_36px_rgba(0,0,0,0.45)] backdrop-blur-xl px-4 sm:px-5 transition-all duration-200 lg:absolute lg:left-4 lg:right-4 lg:top-5 lg:mx-0 lg:mb-0 ${
        minimalProfileOnly
