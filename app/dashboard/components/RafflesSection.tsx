...
import {
  LuGift, LuClock, LuCalendar, LuTag, LuLock,
...
import RafflesDrawer from './RafflesDrawer';
...
const STORE_BACKGROUNDS = [
  ...
  '/store-background/3bears/3bears.gif',
  '/store-background/3bears/3bears2.gif',
  '/store-background/3bears/3bears3.gif',
  '/store-background/3bears/3bears4.gif',
  '/store-background/3bears/3bears5.gif',
  '/store-background/adventure-time/adventure-time.gif',
  '/store-background/adventure-time/adventure-time2.gif',
  '/store-background/adventure-time/adventure-time3.gif',
  '/store-background/adventure-time/adventure-time4.gif',
  '/store-background/adventure-time/adventure-time5.gif',
  '/store-background/adventure-time/adventure-time6.gif',
  '/store-background/gumball/gumball.gif',
  '/store-background/gumball/gumball2.gif',
  '/store-background/gumball/gumball3.gif',
  '/store-background/gumball/gumball4.gif',
  '/store-background/gumball/gumball5.gif',
  '/store-background/gumball/gumball6.gif',
  '/store-background/gumball/gumball7.gif',
];
